...
const RippleEffectBackground = React.memo(function Ripple({
  mainCircleSize = 210,
...
RippleEffectBackground.displayName = 'Ripple Effect Background';

export default RippleEffectBackground;
